 ...
 * @returns {string}
 */
export function ctx_json_dump(ctx) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function ctx_json_dump_variable(_var, ctx) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function ctx_yaml_dump(ctx) {
    let deferred3_0;
    let deferred3_1;
    try {
        var ptr0 = isLikeNone(ctx) ? 0 : passStringToWasm0(ctx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function ctx_yaml_dump_variable(_var, ctx) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(_var, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function run_ctx(ctx, code) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function run_json_ctx(ctx, code) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(ctx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function run_yaml_ctx(ctx, code) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(ctx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('osmia_npm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
